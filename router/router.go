...
import (
	...
	"hello/schoolMission/controller/chaptcha"
	"hello/schoolMission/global/consts"
	"hello/schoolMission/global/variable"
	"hello/schoolMission/middleware/authorization"
	"hello/schoolMission/middleware/cors"
	validatorFactory "hello/schoolMission/validator/core/factory"
	"io"
	"net/http"
	"os"
)
